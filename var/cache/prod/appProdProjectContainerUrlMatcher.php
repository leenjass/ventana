...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/modules')) {
            ...
            // loginascustomer_login_as_customer
            if (0 === strpos($pathinfo, '/modules/login-as-customer') && preg_match('#^/modules/login\\-as\\-customer/(?P<customerId>\\d+)/login\\-as\\-customer$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'loginascustomer_login_as_customer']), array (  '_controller' => 'LoginAsCustomerNamespace\\Controller\\Admin\\LoginAsCustomerController::loginAsCustomerAction',));
                if (!in_array($canonicalMethod, ['GET'])) {
                    $allow = array_merge($allow, ['GET']);
                    goto not_loginascustomer_login_as_customer;
                }

                return $ret;
            }
            not_loginascustomer_login_as_customer:
