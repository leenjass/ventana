                ...
                if (isset($order->id)) {
                    ...
                    foreach ($order->product_list as $product) {
                        ...
                        $product_var_tpl = array(
                            ...
                            'name' => $product['name'] . (isset($product['instructions']) ? ' ' . $product['instructions'] : ''),
