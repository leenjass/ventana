...
* @author Smartsupp <vladimir@smartsupp.com>
	...
	*}
	...
	<div id="smartsupp_page_config" class="panel">
		<header class="header">
			<img src="{$module_dir|escape:'html':'UTF-8'}views/img/smartsupp_logo.png" alt="Smartsupp" />
			<nav>
				<div class="header-user">
					<img class="header-user__avatar" src="{$module_dir|escape:'html':'UTF-8'}views/img/avatar-grey.png"
						alt="avatar" />
					<span class="header-user__email">
						{$smartsupp_email|escape:'htmlall':'UTF-8'}
					</span>
					<button id="btn_deactivate" class="btn btn--sm">
		...
		<main class="main" role="main">
			<div class="main__left">
				<div class="main-all-set">
					...
					<a href="https://dashboard.smartsupp.com/?utm_source=Prestashop&utm_medium=integration&utm_campaign=link"
						target="_blank" class="btn btn--primary btn--arrow">
						{l s='Chat with your visitors' mod='smartsupp'}
					</a>
					<p class="main-all-set__bottom-text">
						{l s='or' mod='smartsupp'} <a
							href="https://app.smartsupp.com/app/settings/chatbox/text?utm_source=Prestashop&utm_medium=integration&utm_campaign=link"
							target="_blank">{l s='Set up' mod='smartsupp'}</a> {l s='chat box design first'
						mod='smartsupp'}
					</p>
				</div>
			</div>
