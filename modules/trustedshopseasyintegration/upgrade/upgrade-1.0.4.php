 ...
 *
 * Update empty credentials if found
 * $credentialsService->getCredentials(); will fire $credentialsService->checkCredentials();
 *
 * @return bool
 *
...
function upgrade_module_1_0_4($module)
{
    ...
    $credentialsService = ServiceContainer::getInstance()->get(CredentialsService::class);
