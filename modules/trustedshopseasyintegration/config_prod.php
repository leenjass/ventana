 ...
 */
if (false == defined('CONNECTOR_URL_JS')) {
    define('CONNECTOR_URL_JS', 'https://static-app.connect.trustedshops.com/connector/connector.umd.js');
}

if (false == defined('EVENTS_URL_JS')) {
    define('EVENTS_URL_JS', 'https://static-app.connect.trustedshops.com/events/eventsLib.js');
}

if (false == defined('CONNECTOR_URL_CSS')) {
    define('CONNECTOR_URL_CSS', 'https://static-app.connect.trustedshops.com/connector/style.css');
}

if (false == defined('TS_API_TOKEN_URL')) {
    define('TS_API_TOKEN_URL', 'https://login.etrusted.com/oauth/token');
}

if (false == defined('TS_API_URL')) {
    define('TS_API_URL', 'api.etrusted.com');
}
