...
class ProductItemModel extends AbstractModel
{
    // region Fields
    ...
    {
        if (is_string($gtin) === true || $gtin == '') {
            $this->gtin = $gtin;

            return $this;
        }

        throw new InvalidArgumentException('Product item gtin must be a string or empty ' . gettype($gtin) . ' is given.');
    }
    ...
    {
        if (is_string($imageUrl) === true || empty($imageUrl)) {
            $this->imageUrl = $imageUrl;

            return $this;
        }

        throw new InvalidArgumentException('Product item image url must be a string or empty ' . gettype($imageUrl) . ' is given.');
    }
    ...
    public function setName($name)
    {
        ...
        throw new InvalidArgumentException('Product item name must be a string or empty ' . gettype($name) . ' is given.');
    }
    ...
    {
        if (is_string($mpn) === true || $mpn == '') {
            $this->mpn = $mpn;

            return $this;
        }

        throw new InvalidArgumentException('Product item mpn must be a string ' . gettype($mpn) . ' is given.');
    }
    ...
    {
        if (is_string($sku) === true) {
            $this->sku = $sku;

            return $this;
        }

        throw new InvalidArgumentException('Product item sku must be a string or empty ' . gettype($sku) . ' is given.');
    }
    ...
    {
        if (is_string($brand) === true || $brand == '') {
            $this->brand = $brand;

            return $this;
        }

        throw new InvalidArgumentException('Product item brand must be a string or empty ' . gettype($brand) . ' is given.');
    }
    ...
    public function setUrl($url)
    {
        ...
        throw new InvalidArgumentException('Product item url must be a string or empty ' . gettype($url) . ' is given.');
    }
