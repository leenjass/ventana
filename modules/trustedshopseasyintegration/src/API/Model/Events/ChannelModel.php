...
use TrustedshopsAddon\API\Constant\ChannelType;
...
class ChannelModel extends AbstractModel
{
     ...
     * @var string
     */
    protected $type = ChannelType::ETRUSTED;
    ...
    public function setId($id)
    {
        ...
        throw new InvalidArgumentException('Channel id must be a string but ' . gettype($id) . ' is given.');
    }
    ...
    public function setType($type)
    {
        ...
        throw new InvalidArgumentException('Channel type must be a string but ' . gettype($type) . ' is given.');
    }
