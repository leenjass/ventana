...
{
    const HEADER = 'wdg-loc-hd';

    const FOOTER = 'wdg-loc-ft';

    const HOME_PAGE = 'wdg-loc-hp';

    const PRODUCT_PAGE = 'wdg-loc-pp';

    const PRODUCT_LIST = 'wdg-loc-pl';

    const PRODUCT_DESCRIPTION = 'wdg-loc-pd';

    const PRODUCT_NAME = 'wdg-loc-pn';

    const LEFT_RIGHT_MARGIN = 'wdg-loc-lrm';
}
