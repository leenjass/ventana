                    ...
                    if (isset($order->id)) {
                        ...
                        foreach ($order->product_list as $product) {
                            ...
                            if (Module::isInstalled('wkproductoptions') && Module::isEnabled('wkproductoptions')) {
                                ...
                                $hasCustomOptions = WkProductCustomerOptions::checkOrderContainsOptionBeforeOrder(
                                    $order->id_cart,
                                    $product['id_product'],
                            ...
                            if ($hasCustomOptions) {
                                ...
                                $productName = $product['name'] . (isset($product['attributes']) ? ' - ' .
                                $product['attributes'] : '');
                            }
                            $product_var_tpl = [
                                'id_product' => $product['id_product'],
                        ...
                        if (count($product_var_tpl_list) > 0) {
                            ...
                            Context::getContext()->smarty->assign('list', $product_var_tpl_list);
                            $product_list_html = Context::getContext()->smarty->fetch(_PS_MODULE_DIR_ . 'wkproductoptions/views/templates/hook/product_list_order_cnf.tpl');
                        }
                        ...
                        if ($id_order_state != Configuration::get('PS_OS_ERROR') && $id_order_state != Configuration::get('PS_OS_CANCELED') && $this->context->customer->id) {
                            ...
                            if (Validate::isEmail($this->context->customer->email)) {
                                $data = [
                                    ...
                                    '{id_order}' => $order->id,
                                    '{date}' => Tools::displayDate(date('Y-m-d H:i:s'), 1),
