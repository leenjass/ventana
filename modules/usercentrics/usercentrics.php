...
class Usercentrics extends Module
{
    ...
    public function hookDisplayHeader()
    {
        ...
        if ($setting_id != '') {
            ...
            $this->smarty->assign(array('enable_sdp' => Configuration::get('USERCENTRICS_ENABLE_SDP')));
    ...
    public function displayUCSettingSettings($setting_id)
    {
        ...
        if ($setting['en'] != false && isset($setting['en'])) {
            ...
            $values['enableSDP'] = Tools::getValue('enableSDP', Configuration::get('USERCENTRICS_ENABLE_SDP'));
            ...
            $fields_form['settings'] = array(
                'form' => array(
                    ...
                    'input' => array(
                        ...
                        array(
                            'type' => 'switch',
                            'label' => $this->l('Enable Smart Data Protector'),
                            'name' => 'enableSDP',
                            'is_bool' => true,
                            'disabled' => false,
                            'values' => array(
        ...
        if (Tools::getIsset('saveUCSetting')) {
            ...
            if (!count($this->module_post_errors)) {
                ...
                if ($this->api->saveSetting(Tools::getValue('setting_id'), $data) !== false) {
                    ...
                    Configuration::updateValue('USERCENTRICS_ENABLE_SDP', Tools::getValue('enableSDP'));
